...
const ZH_TRANSLATIONS = {
  ...
  "colorbox.imageAlt": "ColorBox AI 中文规格确认界面，展示 AI 提取的生产字段、置信度与审单流程",
  "colorbox.imageSrc": "assets/projects/colorbox-ai-review-specs-zh.webp",
  "colorbox.visualLabel": "在线生产审单界面",
  "colorbox.type": "AI 辅助生产审单 · 工厂运营",
  "colorbox.title": "ColorBox AI · 彩盒智能审单系统",
  "colorbox.summary": "一套面向生产的 AI 辅助审单工作流，将客户彩盒资料整理为结构化规格，识别缺失信息与生产风险，并在人工确认后生成标准生产评审单。",
  "colorbox.problem": "彩盒订单常以 PDF、表格、图片、Word、邮件或文本等非结构化形式到达，生产关键信息分散且容易遗漏。",
  "colorbox.system": "客户资料 → AI 提取 → 确定性规则校验 → 人工确认 → 生产评审单。",
  "colorbox.evidence": "字段可编辑并显示置信度；缺失与风险规则、双语客户确认问题、Excel 导出和本地订单记录构成完整闭环。",
  "colorbox.metricsLabel": "ColorBox AI 项目指标",
  "colorbox.metricHuman": "<strong>人工把关</strong> 最终确认",
  "colorbox.metricRules": "<strong>AI + 确定性规则</strong> 双层审单",
  "colorbox.metricLanguages": "<strong>中英双语</strong> 工作流与输出",
  "colorbox.detailsTitle": "审单工作流详情",
  "colorbox.details": "AI 建议始终可编辑，未识别值保持为空；通过 Zod 校验的输出还会由确定性工厂规则复核，最终由人工确认。公开 Demo 仅使用虚构数据，并禁用文件上传与数据库写入；本地工厂模式支持本地文件、可选的 OpenAI 兼容提取、SQLite 历史订单、Excel 导出及打印/PDF。",
